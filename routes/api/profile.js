...
router.get('/github/:username', async (req, res) => {
  try {
    const options = {
      uri: `https://api.github.com/users/${req.params.username}/repos/?per_page=5&sort=created:asc&clientid=${process.env.CLIENTID}&client_secret=${process.env.CLIENTSECRET}`,
      method: 'GET',
